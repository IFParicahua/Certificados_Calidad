...
use App\Imports\DataMecanicaImport;
use Illuminate\Support\Facades\DB;

class ModelImportarMecanica extends Component
{
    use WithFileUploads;
    public $excelid;
    ...
    public function submit(){
        ...
        DB::beginTransaction();
        try {
            Excel::import(new DataMecanicaImport, $this->excelid);
    ...
    {
        return view('livewire.model-importar-mecanica');
    }
}
