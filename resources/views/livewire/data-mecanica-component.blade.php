    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-3">
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            @livewire('model-importar-mecanica')
          </div>
      </div>
        ...
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <div class="py-4 px-5 bg-gray-50">
                <div class="grid grid-cols-9 gap-4 px-3">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($datos as $dato)
                          <tr>
                            ...
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $dato->fy }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                              <div class="text-sm text-gray-900">{{ $dato->fx }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                              <div class="text-sm text-gray-900">{{ $dato->a }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $dato->re }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $dato->d }}</div>
                            </td>
                            <td class="px-6 py-2 whitespace-nowrap text-right text-sm font-medium w-2/12">
                                ...
                                <a wire:click="deleteId({{ $dato->id }})" class=" text-blue-600 text-lg px-3">
      ...
      <div class="col-span-3">
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          @livewire('model-create-mecanica')
        </div>
      </div>
      <!-- Modal -->
