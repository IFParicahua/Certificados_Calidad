    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-3">
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            @livewire('model-importar-geometria')
          </div>
      </div>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($datos as $dato)
                          <tr>
                            ...
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $dato->altura }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                              <div class="text-sm text-gray-900">{{ $dato->espaciamiento }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                              <div class="text-sm text-gray-900">{{ $dato->gap }}</div>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $dato->angulo }}</div>
                            </td>
      ...
      <div class="col-span-3">
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          @livewire('model-create-geometria')
        </div>
      </div>
      <!-- Modal -->
